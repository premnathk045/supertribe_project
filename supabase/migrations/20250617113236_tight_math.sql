/*
  ...
  1. New Tables
    ...
    - `payment_methods` - User payment methods (demo)
  ...
  3. Functions & Triggers
    - `create_user_profile()` function for automatic profile creation
...
DROP POLICY IF EXISTS "Users can read own verification" ON creator_verifications;
...
DROP POLICY IF EXISTS "Verified creators can create posts" ON posts;
DROP POLICY IF EXISTS "Users can update own posts" ON posts;
DROP POLICY IF EXISTS "Everyone can read stories" ON stories;
DROP POLICY IF EXISTS "Verified creators can create stories" ON stories;
