...
- **Modals:** Various modal components for settings, story viewing, post details, and sharing.
...
The application is built using a modern JavaScript stack, leveraging React for the frontend, Vite as the build tool, and a component-based architecture for modularity.

### 2.1 Bolt Framework Implementation

This project is developed within the Bolt framework, which serves as an in-browser AI web development agent. Bolt utilizes WebContainers for the development environment and facilitates real-time code changes based on natural language prompts. The application itself is a standard React application, indicating that Bolt generates and manages the React codebase.

### 2.2 Codebase Structure and Organization

The project follows a clear and modular structure, primarily organized within the `src` directory:
...
Currently using static dummy data in `src/data/dummyData.js`. Production would require a persistent backend database.
...
### 3.1 Existing Features with Detailed Descriptions

#### 3.1.1 Home Page (`HomePage.jsx`)
...
#### 3.1.2 Discover Page (`DiscoverPage.jsx`)
...
#### 3.1.3 Create Post Page (`CreatePostPage.jsx`)
...
#### 3.1.4 Notifications Page (`NotificationsPage.jsx`)
...
#### 3.1.5 Profile Page (`ProfilePage.jsx`)
...
#### 3.1.6 Messages Page (`MessagesPage.jsx`)
**Chat List View:**
...
#### 3.1.7 Modal Components
- **SettingsModal:** Bottom-sheet with settings sections
...
### 3.2 User Flows and Interactions

#### 3.2.1 Core User Flows

**App Launch Flow:**
1. User lands on `HomePage`
2. Views stories carousel and post feed
3. Can navigate via bottom navigation
...
#### 3.3.1 Input Types
- **Text Input:** Search queries, comments, messages, post content, tags, prices
- **File Input:** Media upload (images/videos)
- **User Interactions:** Button clicks, touch gestures, carousel swipes
- **Form Controls:** Toggles, dropdowns, radio buttons

#### 3.3.2 Output Types
- **Content Display:** Posts, stories, profiles, messages
- **Dynamic Updates:** Like counts, follow status, read indicators
- **Modal Dialogs:** Settings, story viewer, post details, sharing
- **Navigation Changes:** Route transitions, page updates
- **Feedback:** Loading indicators, error messages, success states

### 3.4 Business Logic and Validation Rules

#### 3.4.1 Post Content Rules
...
- **Memory Usage:** Efficient cleanup of unused components and data
...
- **API Design:** RESTful or GraphQL APIs with proper pagination
...
- **TopNavigation:** Fixed header with logo, notifications, messages, settings
- **BottomNavigation:** Fixed footer with primary navigation (Home, Discover, Create, Profile)
- **Breadcrumbs:** Context-aware navigation for deep pages

#### 5.1.2 Content Display Components
...
#### 5.3.2 External Service Integrations

**Payment Processing:**
- **Stripe Integration:** For premium content purchases
- **Webhook Handling:** Payment confirmation and failure handling
- **Subscription Management:** Recurring payments for creator subscriptions

**Media Storage:**
- **Cloud Storage:** AWS S3, Cloudinary, or similar for media files
- **CDN Integration:** Global content delivery for optimal performance
- **Image Processing:** Automatic resizing, compression, and format optimization

**Real-time Communication:**
- **WebSocket Connection:** For live messaging and notifications
...
This Product Requirements Document outlines a comprehensive Instagram-like social media platform with modern web technologies and user-centric design. The application provides a solid foundation for content sharing, creator monetization, and social interaction while maintaining scalability and performance standards.

The modular architecture and component-based design facilitate future enhancements and feature additions. The integration of premium content features and creator tools positions the platform for potential monetization and creator economy participation.

Key areas for future development include:
- Backend API implementation with Supabase or similar
...
This PRD serves as a living document that should be updated as the platform evolves and new requirements emerge based on user feedback and market demands.